...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "x", function () awful.spawn("i3lock -c 000000") end,
              {description = "open the screensaver", group = "launcher"}),
    ...
    awful.key({ modkey, "Shift"   }, "semicolon",     function () awful.tag.incnmaster(-1, nil, true) end,
              {description = "decrease the number of master clients", group = "layout"}),
    awful.key({ modkey, "Control" }, "j",     function () awful.tag.incncol( 1, nil, true)    end,
              {description = "increase the number of columns", group = "layout"}),
    awful.key({ modkey, "Control" }, "semicolon",     function () awful.tag.incncol(-1, nil, true)    end,
              {description = "decrease the number of columns", group = "layout"}),
    awful.key({ modkey,           }, "h", function () awful.layout.inc( 1)                end,
